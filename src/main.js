...
const cardNumberPattern = {
  ...
  dispatch: function (appended, dynanicMasked) {
    const number = (dynanicMasked.value + appended).replace(/\D/g, " ")

    const foundMask = dynanicMasked.compiledMasks.find(function (item) {
